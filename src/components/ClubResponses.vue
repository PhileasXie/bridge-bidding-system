...
const oneClubOneDiamondOneNTRebid = ref([
  ...
  { rebid: '2D', points: '13点以上', description: '不符合其他叫品，逼局。' },
  { rebid: '2H', points: '13点以上', description: '5张以上D＋4张H，逼局' },
  { rebid: '2S', points: '13点以上', description: '5张以上D＋4张S，逼局' },  
  { rebid: '2NT', points: '10-12点', description: '5张D＋4张C，不逼叫' },
  { rebid: '3C', points: '13点以上', description: '5张D＋5张C，逼局' },
  { rebid: '3D', points: '13点以上', description: '6张以上D，逼局' },
  { rebid: '3H', points: '13点以上', description: '5张D＋4张C，H单缺，逼局' },
  { rebid: '3S', points: '13点以上', description: '5张D＋4张C，S单缺，逼局' },
